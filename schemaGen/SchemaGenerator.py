...
class SchemaGenerator:
    ...
    #TODO: link to examples parameters.json and column_datatypes.json
    #TODO: JSON schemae
    """
    ...
    def _load_csv(self, input_csv_file):
        ...
        #TODO:
        # - confirm comment syntax for return
    ...
    def _build_schema(self, input_data_as_dataframe, max_values_for_categorical = DEFAULT_MAX_VALUES_FOR_CATEGORICAL, 
        ...
        #TODO:
        # - confirm comment syntax for return value
        ...
        This determines whether a numeric variable is categorical or not by looking
    ...
    def _get_series_dtype(self, series):
        """
        Figure out the datatype that we want to put into our schema files.
